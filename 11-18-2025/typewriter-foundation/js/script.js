...
let Array1 = String1.split(" "); /* splits the string using what is in the "" marks */
console.log(Array1);
...
let MyString3 = MyString2.replace("Earth", "Mars");
console.log(MyString2);
console.log(MyString3);
let MyString4 = MyString2.replace("Earth", "Venus");
